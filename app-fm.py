...
st.set_page_config(page_title="Business Plan", page_icon="🧊", layout="wide", initial_sidebar_state="expanded")
...
model_start = st.sidebar.number_input("Model start", min_value=2020, value=2021, max_value=2100)
forecast_period = st.sidebar.number_input("Forecast period", min_value=3, value=4, max_value=51)

#income statement inputs
st.sidebar.subheader("P&L Assumptions")


revenue_units = st.sidebar.number_input("Number of units sold", min_value=1, value=100000)
revenue_price = st.sidebar.number_input("Price", min_value=0, value=8)
revenue_units_growth = st.sidebar.number_input("Revenue growth",value=0.1)
gross_margin =  st.sidebar.number_input("Gross margin",value=0.40, min_value=0.00, max_value=1.00)
sm_margin = st.sidebar.number_input("S&M as percentage of revenue",value=0.10, min_value=0.00, max_value=1.00)
ga_margin = st.sidebar.number_input("G&A as percentage of revenue",value=0.15, min_value=0.00, max_value=1.00)
depreciation_rate = st.sidebar.number_input("Depreciation rate",value=0.10, min_value=0.00, max_value=1.00)
tax_rate = st.sidebar.number_input("Tax rate",value=0.05, min_value=0.00, max_value=1.00)

#balance sheet input
st.sidebar.subheader("Balance sheet Assumptions")
capex_year0 = st.sidebar.number_input("Annual capital expenditure",value=100000, min_value=0)
capex_growth = -st.sidebar.number_input("capital expenditure growth",value=0.01)
dso = st.sidebar.number_input("Day of outstanding recievables",value=15, min_value=0)
dio = st.sidebar.number_input("Days of outstanding inventory",value=45, min_value=0)
...
#equity assumptions
cap_injection1 = st.sidebar.number_input("Capital injection at year 1",value=100000, min_value=0)
